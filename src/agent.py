...
def inicializar_agente():
    ...
    # Cambiamos al modelo 70B, que es experto en Tool Calling
    ...
    # 5. Diseñar el Prompt / Instrucciones de Sistema
    ...
    - Si el usuario reporta un problema muy general (ej. "tengo un problema"), primero pídele más detalles específicos ANTES de usar cualquier herramienta de búsqueda.""")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        respuesta_bot = responder_consulta(consulta_usuario)
        print(f"\n Agente: {respuesta_bot}\n")
        print("-" * 50)